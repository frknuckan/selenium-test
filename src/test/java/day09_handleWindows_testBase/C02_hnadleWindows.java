...
public class C02_hnadleWindows {
    ...
    public void test01() throws InterruptedException {
        ...
        String ilkSayfaWindowsHandDeğeri=driver.getWindowHandle();
...
// 3- yeni bir pencere acip bestbuy ana sayfaya gidelim
        ...
        String ikinciSayfaWindowsHandDeğeri=driver.getWindowHandle();
...
driver.switchTo().window(ilkSayfaWindowsHandDeğeri);
